...
import companyLogo from "./../shared/logo/logo.png";
...
const SidebarItems = () => {
  ...
  return (
    ...
    <Box sx={{ marginTop: "0px",px: "24px", overflowX: 'hidden' }}>
      <MUI_Sidebar width={"100%"} showProfile={false} themeColor={"#1e4db7"} themeSecondaryColor={'#1a97f51a'}>
        <Box sx={{ margin: "0 -24px" }}>
          <Logo component={NavLink} img={companyLogo} to="/dashboard" style={{textAlign: 'center'}} >IPE</Logo>
          {/* <Typography variant="h3" fontWeight='700' style={{color:'red', textAlign:'center'}}>IPE Platform</Typography> */}
          {/* <img 
         src={companyLogo} 
         alt="Company Logo" 
